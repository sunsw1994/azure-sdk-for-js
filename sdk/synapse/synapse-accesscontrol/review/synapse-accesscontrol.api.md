...
export class AccessControlClient extends AccessControlClientContext {
    ...
    getRoleDefinitions(options?: coreHttp.OperationOptions): Promise<AccessControlClientGetRoleDefinitionsResponse>;
    getRoleDefinitionsNext(nextLink: string, options?: coreHttp.OperationOptions): Promise<AccessControlClientGetRoleDefinitionsNextResponse>;
}
