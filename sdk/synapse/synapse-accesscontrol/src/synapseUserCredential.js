...
function createPipeline(options, credential) {
    ...
    var policy = core_http_1.bearerTokenAuthenticationPolicy(credential, "https://dev.azuresynapse.net/.default");
...
function convertPipelineOptions(options) {
    ...
    if (options.userAgentOptions.userAgentPrefix) {
        options.userAgentOptions.userAgentPrefix = options.userAgentOptions.userAgentPrefix + " " + exports.LIB_INFO;
    }
    else {
